...
gallery/jasmine-kissy/2.0/sub-module/html-mock
gallery/jasmine-kissy/2.0/sub-module/machers
gallery/jasmine-kissy/2.0/index

*/
KISSY.add('gallery/jasmine-kissy/2.0/sub-module/html-mock',function(S,Node,io,Velocity,Parser){
    var $ = Node.all;
...
KISSY.add('gallery/jasmine-kissy/2.0/sub-module/machers',function(S,Node){
    /**
     * 给kissy增加额外的matchers
     */
    beforeEach(function () {
...
KISSY.add('gallery/jasmine-kissy/2.0/index',function(S,HtmlMock){
    return HtmlMock;
