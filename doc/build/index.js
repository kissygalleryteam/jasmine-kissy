...
kg/jasmine-kissy/2.0.0/sub-module/html-mock
kg/jasmine-kissy/2.0.0/sub-module/machers
kg/jasmine-kissy/2.0.0/index

*/
KISSY.add('kg/jasmine-kissy/2.0.0/sub-module/html-mock',function(S,Node,io,Velocity,Parser){
    var $ = Node.all;
...
},{requires:['node','ajax','kg/velocity/1.1/index','kg/velocity/1.1/parse']});
KISSY.add('kg/jasmine-kissy/2.0.0/sub-module/machers',function(S,Node){
    /**
     * 给kissy增加额外的matchers
     */
    beforeEach(function () {
...
KISSY.add('kg/jasmine-kissy/2.0.0/index',function(S,HtmlMock){
    return HtmlMock;
},{requires:['./sub-module/html-mock','./sub-module/machers']});
